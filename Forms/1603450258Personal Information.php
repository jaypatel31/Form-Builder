...
<?php
	...
	$ed = 1603375200;
	$current = time();
	$supreme = "Name,Email,Gender";
	$supreme2 = Array("radio-gp-3");
 ...
 ?>
	...
	<div class="bg-contact2" style="background-image: url('../images/bg-01.jpg');">
		<div class="container-contact2" style="background-color:rgba(247,74,74,0.8)">
			...
			?>
				<form class="contact2-form validate-form">
					...
					<div class="fs-20 pb-5">
						...
						<label>Gender</label><br/><input class='mr-2' type='radio' name='radio-gp-3'value = 'Male 'required >Male <br/><input class='mr-2'  type='radio' name='radio-gp-3'value = 'Female'required >Female<br/></div><div class="container-contact2-form-btn">
